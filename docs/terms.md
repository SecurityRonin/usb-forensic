...
`usb-forensic` is provided under the [Apache License 2.0](https://github.com/SecurityRonin/usb-forensic/blob/main/LICENSE).
...
acquisition and correlation of any USB-device-history artifact or host data —
