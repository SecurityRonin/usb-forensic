...
`usb-forensic` is an offline Rust library. It performs no network communication,
collects no telemetry, and transmits no data of any kind. All correlation of
USB-device-history events happens entirely on your own machine, under your control.
